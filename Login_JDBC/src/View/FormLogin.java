...
public class FormLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblWarn1.setForeground(new java.awt.Color(178, 137, 145));
        ...
        pnlRegisterLayout.setVerticalGroup(
            ...
            .addGroup(pnlRegisterLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(lblWarn2, javax.swing.GroupLayout.DEFAULT_SIZE, 18, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void btRegister2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btRegister2ActionPerformed
        ...
        if(!pass.equals(confirmPass)){
            lblWarn2.setText("Passwords do not match");
            return;
        }
        Account ac = new Customer(fullName, email, pass, gender, birthDay, true , 0);
//        System.out.println(email);
        if(controller.checkExistedAccount(ac)){
